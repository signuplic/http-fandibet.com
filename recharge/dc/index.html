...
<body>
  ...
  <form class="card" id="transferForm">
    <div class="card-top">
      <img src="https://i.postimg.cc/X71CZ2rG/recharge.jpg" alt="recharge">
    </div>
    ...
    <div class="card-bottom">
      ...
      <div class="payment-line">
        <span class="blue-text"><strong>DamaneCash Khawla Imranb</strong> <span class="normal-text">0627498855</span></span>
        <span class="copy-icon" onclick="copyText(this,'0627498855')">
      ...
      <div class="payment-line">
        <span class="blue-text"><strong>Prénom</strong> <span class="normal-text">Imranb</span></span>
        <span class="copy-icon" onclick="copyText(this,'Imranb')">
          <img src="https://i.postimg.cc/ZnpNqgK3/file-000000001e9c620a954f9b15e02be3c1.png" alt="copy-icon">
          <span class="copied-text">Copié</span>
        </span>
      </div>
      ...
      <div class="payment-line">
        <span class="blue-text"><strong>Nom</strong> <span class="normal-text">Khawla</span></span>
        <span class="copy-icon" onclick="copyText(this,'Khawla')">
          <img src="https://i.postimg.cc/ZnpNqgK3/file-000000001e9c620a954f9b15e02be3c1.png" alt="copy-icon">
          <span class="copied-text">Copié</span>
        </span>
      </div>
      ...
      <div class="info-block">
        <div class="info-label">Nom complet (Damane Cash):</div>
        <div class="info-input">
